...
void ggb::BUS::reset()
{
	...
	m_memory[SERIAL_TRANSFER_CONTROL_ADDRESS] = 0x7F; // 7E for DMG
	...
	m_memory[GBC_VRAM_BANKING_ADDRESS] = 0xFE; // TODO for DMG mode VRAM bank must always be zero
	...
	m_memory[GBC_INFRARED_ADDRESS] = 0x3E;
